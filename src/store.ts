...
// Request the periodic notes list to grab focus on its first item (search bar -> periodic Tab navigation)
export const periodicFocusRequest = writable(0)
// Request the periodic notes list to grab focus on its last item (recent filter -> periodic Shift+Tab navigation)
